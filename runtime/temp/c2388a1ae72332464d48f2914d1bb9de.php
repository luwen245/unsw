<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\code\unsw\public/../application/admin\view\content\adddocument.html";i:1594708164;s:55:"D:\code\unsw\application\admin\view\layout\default.html";i:1583049507;s:52:"D:\code\unsw\application\admin\view\common\meta.html";i:1583049507;s:54:"D:\code\unsw\application\admin\view\common\script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <label class="radio-inline">
                <input type="radio" name="row[language]" value="All"> All
            </label>
            ...
            <label class="radio-inline">
                <input type="radio" name="row[language]" value="<?php echo $vo['name']; ?>"> <?php echo $vo['name']; ?>
            </label>
    ...
    <div class="form-group" id="file">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-document" data-rule="required" class="form-control" size="50" name="row[document]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span><button type="button" id="fachoose-document" class="btn btn-primary fachoose" data-input-id="c-document" data-mimetype="zip,rar,xls,xlsx,pdf,doc,ppt" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-publishtime" class="form-control datetimepicker" data-date-format="DD MM YYYY" data-use-current="true" name="row[publishtime]" type="text" value="<?php echo date('d m Y'); ?>">
        </div>
    </div>
