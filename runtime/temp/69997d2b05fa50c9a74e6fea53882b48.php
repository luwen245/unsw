<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\code\unsw\public/../application/admin\view\team\add.html";i:1593692420;s:55:"D:\code\unsw\application\admin\view\layout\default.html";i:1583049507;s:52:"D:\code\unsw\application\admin\view\common\meta.html";i:1583049507;s:54:"D:\code\unsw\application\admin\view\common\script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <input type="hidden" name="row[region_id]" value="<?php echo $region_id; ?>"/>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Region'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-region" data-rule="required" class="form-control" name="row[region]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
