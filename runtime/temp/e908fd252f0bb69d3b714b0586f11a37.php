<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\code\unsw\public/../application/admin\view\content\editnews.html";i:1595249354;s:55:"D:\code\unsw\application\admin\view\layout\default.html";i:1583049507;s:52:"D:\code\unsw\application\admin\view\common\meta.html";i:1583049507;s:54:"D:\code\unsw\application\admin\view\common\script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">Classify:</label>
        <div class="col-xs-12 col-sm-8">
            <select class="form-control" name="row[belong]">
                <option <?php if($row['belong'] == 'Updates'): ?>selected<?php endif; ?> value="Updates">Updates</option>
                <option <?php if($row['belong'] == 'Newsletters'): ?>selected<?php endif; ?> value="Newsletters">Newsletters</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" data-rule="required" class="form-control" rows="5" name="row[content]" cols="50"><?php echo htmlentities($row['content']); ?></textarea>
        </div>
    </div>

    <input type="hidden" name="row[category_id]" value="<?php echo $category_id; ?>"/>
    <input type="hidden" name="row[type]" value="document"/>
    ...
    <div class="form-group" id="file">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-document" data-rule="required" class="form-control" size="50" name="row[document]" type="text" value="<?php echo htmlentities($row['document']); ?>">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="plupload-document" class="btn btn-danger plupload" data-mimetype="zip,rar,xls,xlsx,pdf,doc,docx" data-input-id="c-document" data-multiple="false" data-preview-id="p-document"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <span><button type="button" id="fachoose-document" class="btn btn-primary fachoose" data-mimetype="zip,rar,xls,xlsx,pdf,doc,docx" data-input-id="c-document" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
